class Fetch {
 ...
 class UI {
    ...
    displayUI(data) {
      ...
      <div class="container-fluid">${data.name}</div><span>${data.dt}</span>
      <div class="container-fluid">${data.main.temp}</div>
      <div class="container-fluid">${data.main.humidity}</div>
      <div class="container-fluid">${data.wind.speed}</div>
